...
void saveClipboard(gd::EditorUI* self) {
	auto addr = reinterpret_cast<uintptr_t>(self) + 0x290;
...
void loadClipboard(gd::EditorUI* self) {
	if (g_clipboard && g_clipboard[0]) {
		auto clipboard = reinterpret_cast<uintptr_t>(self) + 0x290;
